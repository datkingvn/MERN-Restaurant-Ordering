    ...
    return (
        <div className='section-container my-20 relative'>
            <div className='text-left'>
                <p className='subtitle'>Các Món Đặc Biệt</p>
                <h3 className='title md:w-[520px]'>Món Ăn Nổi Bật</h3>
            </div>
            ...
            <Slider ref={slider} {...settings} className='overflow-hidden mt-20 space-x-5'>
                {
